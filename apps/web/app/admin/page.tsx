...
import { AuditTab, CombosTab, EvalsTab, MenuTab, NutritionTab, OrdersTab, SettingsTab } from "./tabs";

const TABS = ["Menu", "Orders", "Combos", "Nutrition", "Evals", "Settings", "Audit"] as const;
