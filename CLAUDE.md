...
- [ ] Phase 2: Admin Backend I — IN PROGRESS (`phase/2-admin-backoffice`): DONE — menu ops (#13: CRUD, 86 toggle, scheduling, customizations), settings + kitchen pause + staff RBAC + audit list (#14), admin order mgmt + refunds + migration c41f7a2d9b03 (#15), combo builder + approval flow + ingredients + recipe mapping (#16); event cascade complete (all 3 pubsub channels). REMAINING: nutrition auto-enrichment (LLM batch + evals — first LLM code), admin web UI, business-hours/schedule enforcement
