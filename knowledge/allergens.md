...
|---|---|---|---|---|
| Plain Dosa | vegan | yes | mild | none |
| Masala Dosa | vegan | no | mild | mustard |
| Mysore Masala Dosa | vegan | no | medium | none |
| Ghee Roast Dosa | veg | yes | mild | dairy |
| Podi Dosa | vegan | no | medium | none |
| Onion Dosa | vegan | no | mild | none |
| Rava Dosa | vegan | yes | mild | gluten |
| Set Dosa | vegan | yes | mild | none |
| Cheese Dosa | veg | yes | mild | dairy |
| Kal Dosa | vegan | yes | mild | none |

## Idli & Vada

| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Idli (2 pcs) | vegan | yes | mild | none |
| Mini Idli Sambar | veg | no | mild | dairy |
| Podi Idli | vegan | no | medium | none |
| Medu Vada (2 pcs) | vegan | no | mild | none |
| Curd Vada | veg | yes | mild | dairy, mustard |
| Rava Idli | veg | yes | mild | dairy, gluten, mustard, tree nut (cashew) |
...
| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Ven Pongal | veg | yes | mild | dairy, tree nut (cashew) |
| Sweet Pongal | veg | yes | no spice | dairy, tree nut (cashew) |
| Curd Rice | veg | yes | no spice | dairy, mustard |
| Lemon Rice | vegan | yes | mild | mustard, peanut |
| Tamarind Rice | vegan | yes | medium | peanut |
| Sambar Rice | veg | no | mild | dairy |

## Biryani

| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Chicken Biryani | non-veg | no | medium | dairy |
| Mutton Biryani | non-veg | no | medium | dairy |
| Egg Biryani | non-veg | no | medium | egg |
| Veg Biryani | veg | no | medium | dairy |

## Chettinad Curry

| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Chicken Chettinad | non-veg | no | hot | none |
| Pepper Mutton | non-veg | no | hot | none |
...
| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Aloo Bonda (3 pcs) | vegan | no | mild | none |
| Onion Bajji (4 pcs) | vegan | no | mild | none |
| Parotta (2 pcs) | vegan | no | mild | gluten |
| Kothu Parotta | non-veg | no | medium | egg, gluten |

## Sweets

| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Rava Kesari | veg | yes | no spice | dairy, gluten, tree nut (cashew) |
| Mysore Pak | veg | yes | no spice | dairy |
| Semiya Payasam | veg | yes | no spice | dairy, gluten, tree nut (cashew) |

## Beverages

| Item | Diet | Jain-friendly | Spice | Allergens |
|---|---|---|---|---|
| Filter Coffee | veg | yes | no spice | dairy |
